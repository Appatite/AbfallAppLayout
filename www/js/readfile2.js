...
window.onload = function () {
	...
	var heutigesDatum = getHeutigesDatumView();
					...
					var textnodeDatum = document.createTextNode("Heute ist der " + heutigesDatum);
	...
	for(k=0; k<TonnenAuswahlObj.checkbox.length; k++){
				...
				{	//alert("Checkbox wert true");
					...
					var leerungDatum = muellDatum.substring(2);
					
					var feiertag = muellDatum.substring(0,1);
					//var feiertag = "-";
					
					//alert("Anzeige" +leerung);
					var node = document.createElement("p");
					switch (leerungName) {
					    case "PapierBezirk":
					    	var textnode = document.createTextNode("Papiertonne");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "blue";
					        break;
					    case "WertBezirk":
					    	var textnode = document.createTextNode("Wertstofftonne");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "#FFCC00";
					        break;
					    case "BioBezirk":
					    	var textnode = document.createTextNode("Biotonne");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "brown";
					        break;
					    case "RoterDeckel":
					    	var textnode = document.createTextNode("Hausmüll roter Deckel");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "red";
					        break;
					    case "GrünerDeckel":
					    	var textnode = document.createTextNode("Hausmüll grüner Deckel");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "#00FF00";
					        break;
					    case "BlauerDeckel":
					    	var textnode = document.createTextNode("Hausmüll blauer Deckel");
							node.appendChild(textnode);
							node.setAttribute('class', 'muellBezeichner');
					        node.style.color = "blue";
					        break;
					...
					//node2.style.color = "white";
					    ...
					    case "RoterDeckel":
					        ...
					        break;
					    case "GrünerDeckel":
					        node2.style.color = "#00FF00";
					        break;
					    case "BlauerDeckel":
					        node2.style.color = "#0000FF";
					        break;
					...
					var textnode3 = document.createTextNode("Ein Tag früher als sonst: Feiertagsregelung!");
					node3.appendChild(textnode3);
					node3.setAttribute('class', 'feiertagsBezeichner');
					node3.style.color = "red";
    				anzeigeLeerung.appendChild(node3);
    				}
    				
    				if(feiertag=="+"){
    				var node3 = document.createElement("p");
					var textnode3 = document.createTextNode("Ein Tag später als sonst: Feiertagsregelung!");
					node3.appendChild(textnode3);
					node3.setAttribute('class', 'feiertagsBezeichner');
					node3.style.color = "red";
    				anzeigeLeerung.appendChild(node3);
...
for(i=0; i<leerungskalender.length; i++){
	...
	if(lpapierB ==strasse.papierB ){
		PapierBezirk[counterpapierBezirk]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
		counterpapierBezirk++;
	...
	if(lwertB ==strasse.wertB ){
		WertBezirk[counterwertBezirk]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
		counterwertBezirk++;
	...
	if(lbioB ==strasse.bioB ){
		BioBezirk[counterbioBezirk]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
		counterbioBezirk++;
	...
	if(lwochenT==strasse.tag && lkw==strasse.woche){
		...
		RoterDeckel[counterRoterDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i+1].tag + ":"+leerungskalender[i+1].monat + ":" + leerungskalender[i].jahr;
		...
		RoterDeckel[counterRoterDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
	...
	if(lwochenT==strasse.tag){
		...
		if(leerungskalender[i].FeierLaub=="+"){
		GrünerDeckel[counterGrünerDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i+1].tag + ":"+leerungskalender[i+1].monat + ":" + leerungskalender[i].jahr;
		...
		GrünerDeckel[counterGrünerDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " "  + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
	...
	if(lwochenT==strasse.tag && lblaueTonne=="+"){
		...
		if(leerungskalender[i].FeierLaub=="+"){
		BlauerDeckel[counterBlauerDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i+1].tag + ":"+leerungskalender[i+1].monat + ":" + leerungskalender[i].jahr;
		...
		BlauerDeckel[counterBlauerDeckel]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
	...
	if(leerungskalender[i].FeierLaub=="L"){
		...
		Laub[counterLaub]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
	...
	if(leerungskalender[i].tannenB=="+" && lwochenT==strasse.tag){
		...
		Tanne[counterTanne]=leerungskalender[i].FeierLaub+"x" +leerungskalender[i].wochentag + " " + leerungskalender[i].tag + ":"+leerungskalender[i].monat + ":" + leerungskalender[i].jahr;
...
function getNaechsteLeerung(muellArt, datum)
{
    ...
    for(h=0; h<muellArtArray.length; h++){
    	...
    	//mm>=RDSplitArray[1] && dd >= RDSplitArray[1] mm<=RDSplitArray[1] && dd <= RDSplitArray[0]
    	var ohneWochentag = muellArtArray[h].substring(5);
    	var RDSplitArray = ohneWochentag.split(":");
    	if(mm<RDSplitArray[1] || (mm<=RDSplitArray[1] && dd <= RDSplitArray[0]))
    	{
    		//console.log("Nächste Leerung Roter Deckel"+RoterDeckel[h]);
